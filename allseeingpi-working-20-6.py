...
#toegevoegd voor SSH en SCP toegang
...
# RSYNC naar zero-one poging
#import os
#os.system ("rsync -avz -e /home/pi/allseeingpi/exportImg ssh pi@192.168.0.111:/home/pi/mirror/")
...
# pizero-one one and two
#p = subprocess.Popen(["scp", "latest.gif", "pi@192.168.0.111:/home/pi/mirror/"])
#p = subprocess.Popen(["scp", "latest.gif", "pi@192.168.0.222:/home/pi/mirror/"])
